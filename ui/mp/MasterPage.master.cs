...
{
   static bool[] selectedOption = new bool[7];
    ...
    protected void btnManageUserRoutines_Click(object sender, EventArgs e)
    {
        ...
        selectedOption[0] = selectedOption[2] = selectedOption[3] = selectedOption[4] = selectedOption[5] = selectedOption[6] = false;
        Response.Redirect("~/UserRoutines/default.aspx");
    }
    protected void btnCreateUser(object sender, EventArgs e)
    {
        selectedOption[2] = true;
        selectedOption[1] = selectedOption[0] = selectedOption[3] = selectedOption[4] = selectedOption[5] = selectedOption[6] = false;
    ...
    protected void btnManageExperience(object sender, EventArgs e)
    {
        ...
        selectedOption[1] = selectedOption[2] = selectedOption[0] = selectedOption[4] = selectedOption[5] = selectedOption[6] = false;
    ...
    protected void btnWorkOutSchedule_Click(object sender, EventArgs e)
    {
        ...
        selectedOption[1] = selectedOption[2] = selectedOption[3] = selectedOption[0] = selectedOption[5] = selectedOption[6] = false;
    ...
    protected void btnLogin(object sender, EventArgs e)
    {
        ...
        selectedOption[1] = selectedOption[2] = selectedOption[3] = selectedOption[4] = selectedOption[0] = selectedOption[6] = false;
