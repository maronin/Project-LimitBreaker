                ...
                <asp:MultiView ID="exerciseGoalMultiView" runat="server">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td class="style1">
                                        ...
                                        <asp:NumericUpDownExtender ID="NumericUpDownExtender1" runat="server" TargetControlID="goalTimeTxtBox"
                                            Width="175" Minimum="0" Step="1">
                                        </asp:NumericUpDownExtender>
                                    </td>
                                    <td class="style1">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*Required"
                                            ControlToValidate="goalTimeTxtBox" Display="Dynamic" ForeColor="Red" ValidationGroup="addGoal"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="*Entered values must be a non 0 whole number"
                                            ControlToValidate="goalTimeTxtBox" Display="Dynamic" ForeColor="Red" ValidationExpression="[0-9]+"
                                            ValidationGroup="addGoal"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="style1">
                                    ...
                                    <td class="style1">
                                        ...
                                        <asp:NumericUpDownExtender ID="NumericUpDownExtender2" runat="server" TargetControlID="goalWeightTxtBox"
                                            Width="175" Minimum="0" Step="5">
                                        </asp:NumericUpDownExtender>
                                    </td>
                                    <td class="style1">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*Required"
                                            ControlToValidate="goalWeightTxtBox" Display="Dynamic" ForeColor="Red" ValidationGroup="addGoal"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="*Entered values must be a non 0 whole number"
                                            ControlToValidate="goalWeightTxtBox" Display="Dynamic" ForeColor="Red" ValidationExpression="[0-9]+"
                                            ValidationGroup="addGoal"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="style1">
                                        ...
                                        <asp:NumericUpDownExtender ID="NumericUpDownExtender3" runat="server" TargetControlID="goalDistanceTxtBox"
                                            Width="175" Minimum="0" Step="0.1">
                                        </asp:NumericUpDownExtender>
                                    </td>
                                    <td class="style1">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*Required"
                                            ControlToValidate="goalDistanceTxtBox" Display="Dynamic" ForeColor="Red" ValidationGroup="addGoal"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="*Entered values must be a non 0 double or int (up to 3 decimal places)"
                                            ControlToValidate="goalDistanceTxtBox" Display="Dynamic" ForeColor="Red" ValidationExpression="[0-9]+([\.][0-9]{1,3})?$"
                                            ValidationGroup="addGoal"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="style1">
                                        ...
                                        <asp:NumericUpDownExtender ID="NumericUpDownExtender4" runat="server" TargetControlID="goalRepsTxtBox"
                                            Width="175" Minimum="0" Step="1">
                                        </asp:NumericUpDownExtender>
                                    </td>
                                    <td class="style1">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*Required"
                                            ControlToValidate="goalRepsTxtBox" Display="Dynamic" ForeColor="Red" ValidationGroup="addGoal"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="*Entered values must be a non 0 whole number"
                                            ControlToValidate="goalRepsTxtBox" Display="Dynamic" ForeColor="Red" ValidationExpression="[0-9]+"
                                            ValidationGroup="addGoal"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <asp:View ID="manageGoalsView" runat="server">
                        ...
                        <div style="float: left; padding: 10px;">
                            ...
                            <asp:RadioButtonList ID="achievedRbl" runat="server" RepeatDirection="Horizontal"
                                TextAlign="Left" AutoPostBack="True" Width="230" OnSelectedIndexChanged="achievedRbl_SelectedIndexChanged">
                                <asp:ListItem Selected="True" Value="0">Unachieved</asp:ListItem>
                                <asp:ListItem Value="1">Achieved</asp:ListItem>
                            </asp:RadioButtonList>
                            <asp:ListBox ID="userGoalsListBox" runat="server" AutoPostBack="True" Height="400px"
                                            ...
                                            <asp:Panel ID="modGoalTimePanel" runat="server">
                                                <tr>
                                                    ...
                                                    <td class="style1">
                                                        ...
                                                        <asp:NumericUpDownExtender ID="NumericUpDownExtender5" runat="server" TargetControlID="modGoalTimeTxtBox"
                                                            Width="175" Minimum="0" Step="1">
                                                        </asp:NumericUpDownExtender>
                                                    </td>
                                                    <td class="style1">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*Required"
                                                            ControlToValidate="modGoalTimeTxtBox" Display="Dynamic" ForeColor="Red" ValidationGroup="modifyGoal"></asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ErrorMessage="*Entered values must be a non 0 whole number"
                                                            ControlToValidate="modGoalTimeTxtBox" Display="Dynamic" ForeColor="Red" ValidationExpression="[0-9]+"
                                                            ValidationGroup="modifyGoal"></asp:RegularExpressionValidator>
                                                    </td>
                                                </tr>
                                            </asp:Panel>
                                            <asp:Panel ID="modGoalDistancePanel" runat="server">
                                                <tr>
                                                    ...
                                                    <td class="style1">
                                                        ...
                                                        <asp:NumericUpDownExtender ID="NumericUpDownExtender6" runat="server" TargetControlID="modGoalDistanceTxtBox"
                                                            Width="175" Minimum="0" Step="0.1">
                                                        </asp:NumericUpDownExtender>
                                                    </td>
                                                    <td class="style1">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="*Required"
                                                            ControlToValidate="modGoalDistanceTxtBox" Display="Dynamic" ForeColor="Red" ValidationGroup="modifyGoal"></asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ErrorMessage="*Entered values must be a non 0 double or int (up to 3 decimal places)"
                                                            ControlToValidate="modGoalDistanceTxtBox" Display="Dynamic" ForeColor="Red" ValidationExpression="[0-9]+([\.][0-9]{1,3})?$"
                                                            ValidationGroup="modifyGoal"></asp:RegularExpressionValidator>
                                                    </td>
                                                </tr>
                                            </asp:Panel>
                                            <asp:Panel ID="modGoalWeightPanel" runat="server">
                                                <tr>
                                                    ...
                                                    <td class="style1">
                                                        ...
                                                        <asp:NumericUpDownExtender ID="NumericUpDownExtender7" runat="server" TargetControlID="modGoalWeightTxtBox"
                                                            Width="175" Minimum="0" Step="5">
                                                        </asp:NumericUpDownExtender>
                                                    </td>
                                                    <td class="style1">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="*Required"
                                                            ControlToValidate="modGoalWeightTxtBox" Display="Dynamic" ForeColor="Red" ValidationGroup="modifyGoal"></asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ErrorMessage="*Entered values must be a non 0 whole number"
                                                            ControlToValidate="modGoalWeightTxtBox" Display="Dynamic" ForeColor="Red" ValidationExpression="[0-9]+"
                                                            ValidationGroup="modifyGoal"></asp:RegularExpressionValidator>
                                                    </td>
                                                </tr>
                                            </asp:Panel>
                                            <asp:Panel ID="modGoalRepsPanel" runat="server">
                                                <tr>
                                                    ...
                                                    <td class="style1">
                                                        ...
                                                        <asp:NumericUpDownExtender ID="NumericUpDownExtender8" runat="server" TargetControlID="modGoalRepsTxtBox"
                                                            Width="175" Minimum="0" Step="1">
                                                        </asp:NumericUpDownExtender>
                                                    </td>
                                                    <td class="style1">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="*Required"
                                                            ControlToValidate="modGoalRepsTxtBox" Display="Dynamic" ForeColor="Red" ValidationGroup="modifyGoal"></asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ErrorMessage="*Entered values must be a non 0 whole number"
                                                            ControlToValidate="modGoalRepsTxtBox" Display="Dynamic" ForeColor="Red" ValidationExpression="[0-9]+"
                                                            ValidationGroup="modifyGoal"></asp:RegularExpressionValidator>
                                                    </td>
                                                </tr>
                                            </asp:Panel>
